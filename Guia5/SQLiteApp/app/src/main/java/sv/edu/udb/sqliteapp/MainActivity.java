...
import sv.edu.udb.sqliteapp.AdminSQLiteOpenHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void alta(View v) { AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this,"administracion", null, 1);
